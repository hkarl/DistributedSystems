...
\begin{tikzpicture}
  ...
  \node [fill=gray!20] (m1) at (0,0) {MS 1};
  \node [fill=red!10,align=center] (sr) at (2,0) {Service\\router};
  
  \node [fill=gray!20] (m2a) at (4,0) {MS 2a}; 
  \node [fill=gray!20] (m2b) at (4,-1) {MS 2b}; 
  \node [fill=gray!20] (m2c) at (4,1) {MS 2c}; 
  \node [fill=gray!20] (m3) at (6,0) {MS 3}; 
  ...
  \node [fill=green!10, below =2 of sr, align=center] (registry) {Service\\registry}; 
  \draw [->, thick, dashed, green] (registry) -- (sr); 
  \begin{scope}[on background layer]
  \foreach \k in {a,b,c} {
    \draw [->, thick, dashed, green] (m2\k.south)  -- (registry.east); 
  }
\end{scope}
\end{tikzpicture}
