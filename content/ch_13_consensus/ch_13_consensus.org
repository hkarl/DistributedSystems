...
|----------+----------------------------------------------------------------------+----------------------------------------------------------------------+-------------------------|
| Normal   | \includegraphics[valign=c,width=0.2\linewidth,page=2]{figures/byzantine.pdf}  | \includegraphics[valign=c,width=0.2\linewidth,page=3]{figures/byzantine.pdf} | All decide 0 or 1       |
| C faulty | \includegraphics[valign=c,width=0.2\linewidth,page=4]{figures/byzantine.pdf} | \includegraphics[valign=c,width=0.2\linewidth,page=5]{figures/byzantine.pdf} | A, B decide 1, validity |
| A faulty | \includegraphics[valign=c,width=0.2\linewidth,page=6]{figures/byzantine.pdf} | \includegraphics[valign=c,width=0.2\linewidth,page=7]{figures/byzantine.pdf} | B, C decide 0, validity |
| B faulty | \includegraphics[valign=c,width=0.2\linewidth,page=8]{figures/byzantine.pdf} | \includegraphics[valign=c,width=0.2\linewidth,page=9]{figures/byzantine.pdf} | A, C same (0 or 1)      |
...
|----------+----------------------------------------------------------------------+----------------------------------------------------------------------+---+---+---|
| Normal   | \includegraphics[valign=c, width=0.2\linewidth,page=2]{figures/byzantine.pdf} | \includegraphics[valign=c, width=0.2\linewidth,page=3]{figures/byzantine.pdf} |   |   |   |
| C faulty | \includegraphics[valign=c, width=0.2\linewidth,page=4]{figures/byzantine.pdf} | \includegraphics[valign=c, width=0.2\linewidth,page=5]{figures/byzantine.pdf} | x |   |   |
| A faulty | \includegraphics[valign=c, width=0.2\linewidth,page=6]{figures/byzantine.pdf} | \includegraphics[valign=c, width=0.2\linewidth,page=7]{figures/byzantine.pdf} |   |   | x |
| B faulty | \includegraphics[valign=c, width=0.2\linewidth,page=8]{figures/byzantine.pdf} | \includegraphics[valign=c, width=0.2\linewidth,page=9]{figures/byzantine.pdf} | x |   | x |
...
- Raft: Plenty of implementations available 
