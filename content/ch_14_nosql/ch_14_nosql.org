...
A distributed data store cannot at most two of the following three
properties: 
- Availability
- Consistency
- Partition-tolerance 
...
- Typically: partitions /never happen/ \Smiley 
...
#+ATTR_LaTeX: :width 0.89\linewidth :options page=5
